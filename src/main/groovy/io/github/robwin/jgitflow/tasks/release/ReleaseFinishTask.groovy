...
class ReleaseFinishTask extends AbstractFinalizeTask {
    ...
    void finish() {
        ...
        checkRequirements(flow.getReleaseBranchPrefix(), git, project)
        ...
        ReleaseMergeResult mergeResult = flow.releaseFinish(releaseVersion)
                .setExtension(new ReleaseFinishExtension(project, developVersion))
                .setFetch(true)
